...
class priceDetailTableViewCell: UITableViewCell {
    ...
    func layout (gap: CGFloat) {
        ...
        self.contentView.backgroundColor = detailBackColor
               ...
               addressBtn.frame = CGRect(x: 5, y: itemHeight + gap*2, width: screenSize.width - 20, height: addressHeight)
               ...
               contactPerson.frame = CGRect(x: 5, y: itemHeight + addressHeight + gap*3, width: screenSize.width - 20, height: itemHeight)
               contactPerson.textAlignment = .center
               
               telBtn.frame = CGRect(x: 5, y: itemHeight*2 + addressHeight + gap*4, width: screenSize.width - 20, height: itemHeight)
               ...
               mobilePhoneBtn.frame = CGRect(x: 5, y: itemHeight*3 + addressHeight + gap*5, width: screenSize.width - 20, height: itemHeight)
